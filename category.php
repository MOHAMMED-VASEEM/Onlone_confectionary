...
?>
						<li class="add-cart-button btn-group">
								...
								<?php if($row['productAvailability']=='In Stock'){?>
										<button class="btn btn-primary icon" style="background-color:rgb(0,0,0)" data-toggle="dropdown" type="button">
					...
					<?php } ?>
		                ...
		                <li class="lnk wishlist">
							<a class="add-to-cart" style="background-color:red" href="category.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist" title="Wishlist">
