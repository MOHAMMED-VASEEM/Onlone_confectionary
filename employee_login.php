...
$query=mysqli_query($con,"SELECT * FROM employee WHERE username='$username' and password='$password'");
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="home.html" style="color: #1d3ffa">Home</a></li>
				<li class='active' style="color: #1d3ffa"><a href="employee_login.php" style="color: #1d3ffa"> Employee Login</a></li>
			</ul>
