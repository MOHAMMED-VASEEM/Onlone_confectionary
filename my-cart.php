...
$_SESSION['tp'] = number_format($totalprice, 2); // Format total price with two decimal places
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active' style="color: #1d3ffa">Shopping Cart</li>
			</ul>
		...
		<thead>
			<tr>
				<th>
					...
					<div class="cart-grand-total" style="color: #1d3ffa">
